...
const routes = [
  ...
  { path: '/reports', name: 'reports', component: () => import('@/pages/AllReportsPage.vue'), meta: { requiresAuth: true } },
  { path: '/reports/closed', name: 'reports-closed', component: () => import('@/pages/ClosedReportsPage.vue'), meta: { requiresAuth: true } },
  { path: '/reports/make', name: 'reports-make', component: () => import('@/pages/MakeReportPage.vue'), meta: { requiresAuth: true } },
  { path: '/reports/:id', name: 'report-detail', component: () => import('@/pages/ReportDetailPage.vue'), meta: { requiresAuth: true } },
